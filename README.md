...
<body>
  ...
  <section id="home" class="hero">
    <h1>Hello, I'm <span>MR__SHAIK JUNAID S</span></h1>
  ...
  <section id="about" class="about">
    ...
    <div class="about-content">
      <img src="Screenshot_20250915_095600.jpg" alt="Profile Photo">
  ...
  <footer>
    <p>&copy; 2025 SHAIK JUNAID S| All Rights Reserved</p>
  </footer>
  ...
  <script>
    ...
    const quizData = [
      { question: "Which CSS property is used to change the background color of an element?",
        a: "bgcolor", b: "background", c: "color", d: "background-color", correct: "d" },
      { question: "Which property is used to change the font size of an element?",
        a: "font-style", b: "text-size", c: "font-size", d: "font", correct: "c" },
      { question: "Which value of the display property hides an element completely?",
        a: "hidden", b: "opacity:0;", c: "display:none;", d: "visibility:hidden;", correct: "c" },
      { question: "Which is used for databases?",
        a: "PHP", b: "MySQL", c: "HTML", d: "CSS", correct: "b" }
    ];
